...
\section[Univers]{Catégorie de manga en fonction de l'univers}
...
\section[Caractères]{Caractères typiques des personnages}
...
\section[Différences]{La différence entre le Japon et la France}
